...
public class Champ extends AbstractMonster {
    ...
    public Champ() {
        super(NAME, "Champ", 420, 0.0F, -15.0F, 400.0F, 410.0F, (String)null, -90.0F, 0.0F);
        this.type = EnemyType.BOSS;
        this.dialogX = -100.0F * Settings.scale;
        this.dialogY = 10.0F * Settings.scale;
        this.loadAnimation("images/monsters/theCity/champ/skeleton.atlas", "images/monsters/theCity/champ/skeleton37.json", 1.0F);
    ...
    public void takeTurn() {
        ...
        switch (this.nextMove) {
            ...
            case 3:
                ...
                this.damage.get(1).base=this.getPower(MetallicizePower.POWER_ID).amount;
            ...
            case 7:
                ...
                AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(this, this, new MetallicizePower(this, this.strAmt * 3), this.strAmt * 3));
    ...
    public void changeState(String key) {
        switch (key) {
            ...
            case"DEFEND":
                ...
                this.state.addAnimation(0, "efendidle", true, 0.0F);
            default:
        }
    }
    ...
    protected void getMove(int num) {
        ...
        if (this.currentHealth < this.maxHealth / 2 && !this.thresholdReached) {
            ...
            this.setMove("盾击", (byte)3, Intent.ATTACK, this.getPower(MetallicizePower.POWER_ID).amount, 1, false);
