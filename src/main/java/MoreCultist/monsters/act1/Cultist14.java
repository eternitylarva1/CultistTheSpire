...
import MoreCultist.powers.RupturePower1;
    ...
    public void takeTurn() {
        switch (this.nextMove) {
            ...
            case 3:
                ...
                Cultist14 a1=new Cultist14();
                a1.issummoned=true;
                AbstractDungeon.actionManager.addToBottom(new SpawnMonsterAction(new Cultist14(), false));
                a1.drawX=this.drawX+100;
                a1.maxHealth=this.currentHealth;
            ...
            case 4:
                ...
                AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(this,this,new RupturePower1(this,1)));
